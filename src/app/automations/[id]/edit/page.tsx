...
export default function EditAutomationPage() {
  ...
  const form = useForm<AutomationFormValues>({
    ...
    defaultValues: {
      name: "Mock Daily Export",
      description: "This is a mock automation.",
  ...
  return (
    <AppShell breadcrumbs={[{ label: "Automations", href: "/automations" }, { label: "Edit" }]}>
      <div className="flex flex-col gap-6 max-w-4xl mx-auto pb-12">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-3xl font-bold tracking-tight">Edit Automation</h1>
            <p className="text-muted-foreground mt-2">
              Update your browser automation workflow.
            </p>
          </div>
        </div>
