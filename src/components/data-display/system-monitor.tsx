      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        ...
        <Card className="bg-gradient-to-br from-card to-card/50 border-border/50 shadow-sm">
          ...
          <CardContent>
            ...
            <div className="w-full h-1.5 bg-secondary rounded-full mt-2">
              <div 
                className={`h-1.5 rounded-full ${memPercent > 80 ? 'bg-destructive' : 'bg-violet-500'}`} 
        ...
        <Card className="bg-gradient-to-br from-card to-card/50 border-border/50 shadow-sm">
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            ...
            <HardDrive className="h-4 w-4 text-fuchsia-500" />
          </CardHeader>
          <CardContent>
            <div className="text-2xl font-bold">{storagePercent.toFixed(1)}%</div>
            <div className="w-full h-1.5 bg-secondary rounded-full mt-2">
              <div 
                className={`h-1.5 rounded-full ${storagePercent > 90 ? 'bg-destructive' : 'bg-fuchsia-500'}`} 
